...
// software trigger, no averaging. Hi this is Rishaan, I copy pasted like this whole thing from the textbook...
  ADC1->ULLMEM.GPRCM.RSTCTL = 0xB1000003; // 1) reset
  ADC1->ULLMEM.GPRCM.PWREN = 0x26000001;  // 2) activate
  Clock_Delay(24);                        // 3) wait
  IOMUX->SECCFG.PINCM[IOMUX_PINCM40] = 0x00000000; // PB18 analog
